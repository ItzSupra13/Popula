...
def main():
    ...
    st.markdown('<h1 class="main-header">Popula</h1>', unsafe_allow_html=True)
    st.markdown(
    ...
    # API Quota Info
    st.info("""
    ℹ️ **Google Gemini API Free Tier Limits (3.1 Flash Lite)**
    ...
    <div style="text-align: center; color: #666; font-size: 0.9rem;">
        Popula | Hybrid AI Architecture: LLM + Neural Network | 
